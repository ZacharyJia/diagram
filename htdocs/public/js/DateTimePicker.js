...
$.DateTimePicker = $.DateTimePicker || {
	...
	defaults:  //Plugin Defaults
	{
		...
		labels: {"year": "年", "month": "月", "day": "日", "hour": "时", "minutes": "分", "seconds": "秒", "meridiem": "Meridiem"},
	...
	DateTimePicker.prototype = {
		...
		_modifyPicker: function()
		{
			...
			if(oDTP.settings.showHeader)
			{
				...
				sHeader += "<div class='dtpicker-title' style='font-size: 18px'>" + sTitleContent + "</div>";
