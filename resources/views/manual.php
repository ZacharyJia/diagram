...
<script src="js/loadSensor.js" onload="loadSensor('manual')"></script>
<script src="js/timeFormatter.js"></script>
<script src="js/dataRefrash.js" onload="realTimeRefrash('manual')"></script>
                ...
                <div class="style_1">
                    <div id="searchform">
                        <fieldset>
                            ...
                            <input id="search" name="search" type="submit" value="" onclick="searchSensor('manual')"/>
                        </fieldset>
                    </div>
                </div>
            </div>
