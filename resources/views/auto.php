...
<!--    <nav>-->
<!--        <a href="logout" style="right:120px; position: absolute;height: 60px;line-height: 60px;">注销</a>-->
<!--    </nav>-->
</header>
            ...
            <table style="margin:0 auto; top: 10px;">
                <tr>
                    ...
                    <td>
                        ...
                        <div id="setDateTime">
                            <input type="submit" value="查询" onclick="setDateTime('auto')"/>
                        </div>
                    </td>
                </tr>
            </table>
...
<script type="text/javascript">
    ...
    auto_MyChart.setOption(auto_Option);
</script>
